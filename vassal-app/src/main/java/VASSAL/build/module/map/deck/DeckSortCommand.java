...
public class DeckSortCommand extends AbstractDeckKeyCommand {
  ...
  public DeckSortCommand(String name, String menuText, String format, NamedKeyStroke key) {
  ...
  public void performAction() {
    if (isEnabled()) {
      // FIXME getDeck().sort(sortKey, sortDescending);
    }
  }
  ...
  public boolean isEnabled() {
    // FIXME return getDeck().isSortable();
    return false;
  }
